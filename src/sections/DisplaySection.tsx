...
const DisplaySection = () => {
  ...
  useLayoutEffect(() => {
    let t1 = gsap
      ...
      .fromTo(textOne.current, { x: 0, y: 0 }, { x: '-20%', y: '-60%' }, 'key1')
      .fromTo(textTwo.current, { x: 0, y: 0 }, { x: '20%', y: '60%' }, 'key1');
  ...
  return (
    <Section>
      ...
      <TextBlockRight>
        ...
        <Text>
          Lorem ipsum, dolor sit amet consectetur adipisicing elit. Necessitatibus dignissimos
          ipsam.
        </Text>
      </TextBlockRight>
      ...
      <TextContainer>
        <MovingText ref={textOne}>
          Жестче, <br /> чем когда-либо!
        </MovingText>
        <MovingText ref={textTwo}>
          Каждое прикосновение <br /> имеет значение.
        </MovingText>
      </TextContainer>
    </Section>
  );
